/**
 * @file cfn_sal_utl_serialization.h
...
#ifndef CAFFEINE_SAL_UTL_SERIALIZATION_H
#define CAFFEINE_SAL_UTL_SERIALIZATION_H
 ...
 */
#define CFN_SAL_UTL_SERIALIZATION_SCHEMA_START(name)                                                                   \
    static const cfn_sal_utl_serialization_schema_field_t name##_fields[] = {
...
typedef enum
{
    ...
    CFN_SAL_UTL_SERIALIZATION_SCHEMA_FIELD_TYPE_STRING, /*!< Null-terminated char array */
    CFN_SAL_UTL_SERIALIZATION_SCHEMA_FIELD_TYPE_BYTES,  /*!< Raw byte array */
...
typedef struct
{
    ...
    cfn_sal_utl_serialization_schema_field_type_t type;   /*!< Data type of the field */
    uint16_t                                      offset; /*!< Offset from the start of the struct */
    uint16_t                                      size;   /*!< Size of the field in bytes */
} cfn_sal_utl_serialization_schema_field_t;
...
typedef struct
{
    ...
    size_t                                          count;
} cfn_sal_utl_serialization_schema_t;
...
typedef void (*cfn_sal_utl_serialization_callback_t)(cfn_sal_utl_serialization_t *driver,
                                                     uint32_t                     event,
                                                     uint32_t                     error,
                                                     void                        *user_arg);
...
struct cfn_sal_utl_serialization_api_s
{
     ...
     */
    cfn_hal_error_code_t (*encode)(cfn_sal_utl_serialization_t              *driver,
     ...
     */
    cfn_hal_error_code_t (*decode)(cfn_sal_utl_serialization_t              *driver,
                                   const cfn_sal_utl_serialization_schema_t *schema,
     ...
     */
    cfn_hal_error_code_t (*encode_stream)(cfn_sal_utl_serialization_t              *driver,
                                          const cfn_sal_utl_serialization_schema_t *schema,
                                          const void                               *data_ptr,
                                          void                                     *out_stream);
     ...
     */
    cfn_hal_error_code_t (*decode_stream)(cfn_sal_utl_serialization_t              *driver,
                                          const cfn_sal_utl_serialization_schema_t *schema,
                                          void                                     *in_stream,
                                          void                                     *data_ptr);
};
                                                       ...
                                                       void                                     *user_arg)
{
    CFN_HAL_POPULATE_DRIVER(
        driver, CFN_SAL_UTL_TYPE_SERIALIZATION, peripheral_id, NULL, dependency, api, phy, config, callback, user_arg);
}
                                                                     ...
                                                                     size_t *bytes_written)
{
    ...
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(
        CFN_SAL_UTL_TYPE_SERIALIZATION, encode, driver, error, schema, data_ptr, out_buf, out_size, bytes_written);
    return error;
}
                                                                     ...
                                                                     size_t *bytes_read)
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(
        CFN_SAL_UTL_TYPE_SERIALIZATION, decode, driver, error, schema, in_buf, in_size, data_ptr, bytes_read);
    return error;
}
...
cfn_sal_utl_serialization_encode_stream(cfn_sal_utl_serialization_t              *driver,
                                        const cfn_sal_utl_serialization_schema_t *schema,
                                        const void                               *data_ptr,
                                        void                                     *out_stream)
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(
        CFN_SAL_UTL_TYPE_SERIALIZATION, encode_stream, driver, error, schema, data_ptr, out_stream);
    return error;
}
 ...
 */
CFN_HAL_INLINE cfn_hal_error_code_t
cfn_sal_utl_serialization_decode_stream(cfn_sal_utl_serialization_t              *driver,
                                        const cfn_sal_utl_serialization_schema_t *schema,
                                        void                                     *in_stream,
                                        void                                     *data_ptr)
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(
        CFN_SAL_UTL_TYPE_SERIALIZATION, decode_stream, driver, error, schema, in_stream, data_ptr);
    return error;
}
...
#endif /* CAFFEINE_SAL_UTL_SERIALIZATION_H */
