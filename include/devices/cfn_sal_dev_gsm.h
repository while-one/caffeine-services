/**
 * @file cfn_sal_dev_gsm.h
 * @brief Abstract GSM/Cellular service interface.
 */

#ifndef CAFFEINE_SAL_DEV_GSM_H
#define CAFFEINE_SAL_DEV_GSM_H
...
typedef enum
{
    CFN_SAL_DEV_GSM_EVENT_NONE               = 0,
    CFN_SAL_DEV_GSM_EVENT_POWERED_ON         = CFN_HAL_BIT(0),
    CFN_SAL_DEV_GSM_EVENT_NETWORK_REGISTERED = CFN_HAL_BIT(1),
    CFN_SAL_DEV_GSM_EVENT_SMS_RECEIVED       = CFN_HAL_BIT(2),
    CFN_SAL_DEV_GSM_EVENT_CALL_INCOMING      = CFN_HAL_BIT(3),
    CFN_SAL_DEV_GSM_EVENT_MQTT_CONNECTED     = CFN_HAL_BIT(4),
} cfn_sal_dev_gsm_event_t;

typedef enum
{
    CFN_SAL_DEV_GSM_NET_NOT_REGISTERED = 0,
...
struct cfn_sal_dev_gsm_api_s
{
    ...
    cfn_hal_error_code_t (*read_sms)(
        cfn_sal_dev_gsm_t *driver, uint16_t index, char *number_out, char *message_out, size_t max_len);
    ...
    cfn_hal_error_code_t (*mqtt_publish)(cfn_sal_dev_gsm_t *driver,
                                         const char        *topic,
                                             ...
                                             void                           *user_arg)
{
    CFN_HAL_POPULATE_DRIVER(
        driver, CFN_SAL_DEV_TYPE_GSM, peripheral_id, NULL, dependency, api, phy, config, callback, user_arg);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_gsm_config_validate(const cfn_sal_dev_gsm_t        *driver,
                                                                    const cfn_sal_dev_gsm_config_t *config)
{
    if (!driver || !config)
    {
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_gsm_deinit(cfn_sal_dev_gsm_t *driver)
{
    ...
    return cfn_hal_base_deinit(&driver->base, CFN_SAL_DEV_TYPE_GSM);
}
                                                                      ...
                                                                      void                      *user_arg)
{
    ...
    return cfn_hal_base_callback_register(&driver->base, CFN_SAL_DEV_TYPE_GSM, (cfn_hal_callback_t) callback, user_arg);
}
                                                                    ...
                                                                    cfn_hal_power_state_t state)
{
    ...
    return cfn_hal_power_state_set(&driver->base, CFN_SAL_DEV_TYPE_GSM, state);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_gsm_event_enable(cfn_sal_dev_gsm_t *driver, uint32_t event_mask)
{
    ...
    return cfn_hal_base_event_enable(&driver->base, CFN_SAL_DEV_TYPE_GSM, event_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_gsm_event_disable(cfn_sal_dev_gsm_t *driver, uint32_t event_mask)
{
    ...
    return cfn_hal_base_event_disable(&driver->base, CFN_SAL_DEV_TYPE_GSM, event_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_gsm_event_get(cfn_sal_dev_gsm_t *driver, uint32_t *event_mask)
{
    ...
    return cfn_hal_base_event_get(&driver->base, CFN_SAL_DEV_TYPE_GSM, event_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_gsm_error_enable(cfn_sal_dev_gsm_t *driver, uint32_t error_mask)
{
    ...
    return cfn_hal_base_error_enable(&driver->base, CFN_SAL_DEV_TYPE_GSM, error_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_gsm_error_disable(cfn_sal_dev_gsm_t *driver, uint32_t error_mask)
{
    ...
    return cfn_hal_base_error_disable(&driver->base, CFN_SAL_DEV_TYPE_GSM, error_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_gsm_error_get(cfn_sal_dev_gsm_t *driver, uint32_t *error_mask)
{
    ...
    return cfn_hal_base_error_get(&driver->base, CFN_SAL_DEV_TYPE_GSM, error_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_gsm_power_on(cfn_sal_dev_gsm_t *driver)
{
    ...
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_DEV_TYPE_GSM, power_on, driver, error);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_DEV_TYPE_GSM, power_off, driver, error);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_DEV_TYPE_GSM, reset, driver, error);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, get_signal_quality, driver, error, rssi_dbm);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, get_network_status, driver, error, status);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, send_sms, driver, error, number, text);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, http_get, driver, error, url, response, len);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, mqtt_publish, driver, error, topic, payload, len);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, get_imei, driver, error, imei_out, max_len);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, get_imsi, driver, error, imsi_out, max_len);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, get_iccid, driver, error, iccid_out, max_len);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, get_operator, driver, error, operator_out, max_len);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, get_signal_quality_csq, driver, error, csq_out);
    return error;
}

CFN_HAL_INLINE cfn_hal_error_code_t
cfn_sal_dev_gsm_read_sms(cfn_sal_dev_gsm_t *driver, uint16_t index, char *number_out, char *message_out, size_t max_len)
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(
        CFN_SAL_DEV_TYPE_GSM, read_sms, driver, error, index, number_out, message_out, max_len);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_GSM, dial, driver, error, number);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_DEV_TYPE_GSM, answer, driver, error);
    return error;
}
