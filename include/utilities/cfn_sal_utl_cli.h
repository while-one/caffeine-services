/**
 * @file cfn_sal_utl_cli.h
 * @brief Abstract Command Line Interface (CLI) service interface.
 */

#ifndef CAFFEINE_SAL_UTL_CLI_H
#define CAFFEINE_SAL_UTL_CLI_H
...
typedef enum
{
    CFN_SAL_UTL_CLI_EVENT_NONE      = 0,
    CFN_SAL_UTL_CLI_EVENT_CMD_START = CFN_HAL_BIT(0),
    CFN_SAL_UTL_CLI_EVENT_CMD_DONE  = CFN_HAL_BIT(1),
...
CFN_SAL_CREATE_DRIVER_TYPE(
    sal_utl_cli, cfn_sal_utl_cli_config_t, cfn_sal_utl_cli_api_t, cfn_sal_phy_t, cfn_sal_utl_cli_callback_t);
                                             ...
                                             void                           *user_arg)
{
    CFN_HAL_POPULATE_DRIVER(
        driver, CFN_SAL_UTL_TYPE_CLI, peripheral_id, NULL, dependency, api, phy, config, callback, user_arg);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_utl_cli_init(cfn_sal_utl_cli_t *driver)
{
    ...
    return cfn_hal_base_init(&driver->base, CFN_SAL_UTL_TYPE_CLI);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_utl_cli_deinit(cfn_sal_utl_cli_t *driver)
{
    ...
    return cfn_hal_base_deinit(&driver->base, CFN_SAL_UTL_TYPE_CLI);
}
                                                               ...
                                                               const cfn_sal_utl_cli_config_t *config)
{
    ...
    return cfn_hal_base_config_set(&driver->base, CFN_SAL_UTL_TYPE_CLI, (const void *) config);
}
                                                                      ...
                                                                      void                      *user_arg)
{
    ...
    return cfn_hal_base_callback_register(&driver->base, CFN_SAL_UTL_TYPE_CLI, (cfn_hal_callback_t) callback, user_arg);
}
                                                                    ...
                                                                    cfn_hal_power_state_t state)
{
    ...
    return cfn_hal_power_state_set(&driver->base, CFN_SAL_UTL_TYPE_CLI, state);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_utl_cli_event_enable(cfn_sal_utl_cli_t *driver, uint32_t event_mask)
{
    ...
    return cfn_hal_base_event_enable(&driver->base, CFN_SAL_UTL_TYPE_CLI, event_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_utl_cli_event_disable(cfn_sal_utl_cli_t *driver, uint32_t event_mask)
{
    ...
    return cfn_hal_base_event_disable(&driver->base, CFN_SAL_UTL_TYPE_CLI, event_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_utl_cli_event_get(cfn_sal_utl_cli_t *driver, uint32_t *event_mask)
{
    ...
    return cfn_hal_base_event_get(&driver->base, CFN_SAL_UTL_TYPE_CLI, event_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_utl_cli_error_enable(cfn_sal_utl_cli_t *driver, uint32_t error_mask)
{
    ...
    return cfn_hal_base_error_enable(&driver->base, CFN_SAL_UTL_TYPE_CLI, error_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_utl_cli_error_disable(cfn_sal_utl_cli_t *driver, uint32_t error_mask)
{
    ...
    return cfn_hal_base_error_disable(&driver->base, CFN_SAL_UTL_TYPE_CLI, error_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_utl_cli_error_get(cfn_sal_utl_cli_t *driver, uint32_t *error_mask)
{
    ...
    return cfn_hal_base_error_get(&driver->base, CFN_SAL_UTL_TYPE_CLI, error_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_utl_cli_feed_char(cfn_sal_utl_cli_t *driver, char c)
{
    ...
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_UTL_TYPE_CLI, feed_char, driver, error, c);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_UTL_TYPE_CLI, print_string, driver, error, str);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_UTL_TYPE_CLI, print_line, driver, error, str);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_UTL_TYPE_CLI, register_command, driver, error, cmd);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_UTL_TYPE_CLI, unregister_command, driver, error, name);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_UTL_TYPE_CLI, set_prompt, driver, error, prompt);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_UTL_TYPE_CLI, clear_screen, driver, error);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_UTL_TYPE_CLI, register_command_simple, driver, error, cmd, callback);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_UTL_TYPE_CLI, print_help, driver, error);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_UTL_TYPE_CLI, history_prev, driver, error);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_UTL_TYPE_CLI, history_next, driver, error);
    return error;
}
