/**
 * @file cfn_sal_dev_led.h
 * @brief Abstract LED service interface.
 */

#ifndef CAFFEINE_SAL_DEV_LED_H
#define CAFFEINE_SAL_DEV_LED_H
...
#define CFN_SAL_DEV_TYPE_LED CFN_SAL_TYPE('L', 'E', 'D')
...
typedef struct
{
    ...
    void *custom;
} cfn_sal_dev_led_config_t;

typedef struct cfn_sal_dev_led_s     cfn_sal_dev_led_t;
typedef struct cfn_sal_dev_led_api_s cfn_sal_dev_led_api_t;

typedef void (*cfn_sal_dev_led_callback_t)(cfn_sal_dev_led_t *driver, uint32_t event, uint32_t error, void *user_arg);
...
CFN_HAL_INLINE void cfn_sal_dev_led_populate(cfn_sal_dev_led_t              *driver,
                                             uint32_t                        peripheral_id,
                                             void                           *dependency,
                                             const cfn_sal_dev_led_api_t    *api,
                                             const cfn_sal_phy_t            *phy,
                                             const cfn_sal_dev_led_config_t *config,
                                             cfn_sal_dev_led_callback_t      callback,
                                             void                           *user_arg)
{
    CFN_HAL_POPULATE_DRIVER(
        driver, CFN_SAL_DEV_TYPE_LED, peripheral_id, NULL, dependency, api, phy, config, callback, user_arg);
}

cfn_hal_error_code_t cfn_sal_dev_led_construct(cfn_sal_dev_led_t              *driver,
                                               const cfn_sal_dev_led_config_t *config,
                                               const cfn_sal_phy_t            *phy,
                                               void                           *dependency,
                                               cfn_sal_dev_led_callback_t      callback,
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_deinit(cfn_sal_dev_led_t *driver)
{
    ...
    return cfn_hal_base_deinit(&driver->base, CFN_SAL_DEV_TYPE_LED);
}

CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_config_set(cfn_sal_dev_led_t              *driver,
                                                               const cfn_sal_dev_led_config_t *config)
{
    if (!driver)
    {
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_config_get(cfn_sal_dev_led_t        *driver,
                                                               cfn_sal_dev_led_config_t *config)
{
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_callback_register(cfn_sal_dev_led_t         *driver,
                                                                      cfn_sal_dev_led_callback_t callback,
                                                                      void                      *user_arg)
{
    if (!driver)
    ...
    return cfn_hal_base_callback_register(&driver->base, CFN_SAL_DEV_TYPE_LED, (cfn_hal_callback_t) callback, user_arg);
}

CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_power_state_set(cfn_sal_dev_led_t    *driver,
                                                                    cfn_hal_power_state_t state)
{
    ...
    return cfn_hal_power_state_set(&driver->base, CFN_SAL_DEV_TYPE_LED, state);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_event_enable(cfn_sal_dev_led_t *driver, uint32_t event_mask)
{
    ...
    return cfn_hal_base_event_enable(&driver->base, CFN_SAL_DEV_TYPE_LED, event_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_event_disable(cfn_sal_dev_led_t *driver, uint32_t event_mask)
{
    ...
    return cfn_hal_base_event_disable(&driver->base, CFN_SAL_DEV_TYPE_LED, event_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_event_get(cfn_sal_dev_led_t *driver, uint32_t *event_mask)
{
    ...
    return cfn_hal_base_event_get(&driver->base, CFN_SAL_DEV_TYPE_LED, event_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_error_enable(cfn_sal_dev_led_t *driver, uint32_t error_mask)
{
    ...
    return cfn_hal_base_error_enable(&driver->base, CFN_SAL_DEV_TYPE_LED, error_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_error_disable(cfn_sal_dev_led_t *driver, uint32_t error_mask)
{
    ...
    return cfn_hal_base_error_disable(&driver->base, CFN_SAL_DEV_TYPE_LED, error_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_error_get(cfn_sal_dev_led_t *driver, uint32_t *error_mask)
{
    ...
    return cfn_hal_base_error_get(&driver->base, CFN_SAL_DEV_TYPE_LED, error_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_set_state(cfn_sal_dev_led_t *driver, cfn_sal_dev_led_state_t state)
{
    ...
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_LED, set_state, driver, error, state);
    return error;
}

CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_get_state(cfn_sal_dev_led_t       *driver,
                                                              cfn_sal_dev_led_state_t *state_out)
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_LED, get_state, driver, error, state_out);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_DEV_TYPE_LED, toggle, driver, error);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_LED, set_brightness, driver, error, percent);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_LED, get_brightness, driver, error, percent_out);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_LED, set_color, driver, error, color);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_DEV_TYPE_LED, blink_start, driver, error, period_ms);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_DEV_TYPE_LED, blink_stop, driver, error);
    return error;
}

CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_dev_led_set_blink(cfn_sal_dev_led_t *driver,
