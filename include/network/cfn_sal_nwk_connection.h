/**
 * @file cfn_sal_nwk_connection.h
 * @brief Generic abstract interface for link-layer connection management.
 */

#ifndef CAFFEINE_SAL_NWK_CONNECTION_H
#define CAFFEINE_SAL_NWK_CONNECTION_H
...
typedef enum
{
    CFN_SAL_NWK_CONNECTION_EVENT_NONE         = 0,
    CFN_SAL_NWK_CONNECTION_EVENT_CONNECTED    = CFN_HAL_BIT(0),
    CFN_SAL_NWK_CONNECTION_EVENT_DISCONNECTED = CFN_HAL_BIT(1),
    CFN_SAL_NWK_CONNECTION_EVENT_LINK_LOST    = CFN_HAL_BIT(2),
...
typedef void (*cfn_sal_nwk_connection_callback_t)(cfn_sal_nwk_connection_t *driver,
                                                  uint32_t                  event,
                                                  uint32_t                  error,
                                                  void                     *user_arg);
...
struct cfn_sal_nwk_connection_api_s
{
    ...
    cfn_hal_error_code_t (*set_static_ip)(cfn_sal_nwk_connection_t *driver,
                                          const uint8_t            *ip,
                                          const uint8_t            *mask,
                                                    ...
                                                    void                                  *user_arg)
{
    CFN_HAL_POPULATE_DRIVER(
        driver, CFN_SAL_NWK_TYPE_CONNECTION, peripheral_id, NULL, dependency, api, phy, config, callback, user_arg);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_nwk_connection_deinit(cfn_sal_nwk_connection_t *driver)
{
    ...
    return cfn_hal_base_deinit(&driver->base, CFN_SAL_NWK_TYPE_CONNECTION);
}
                                                                             ...
                                                                             void                             *user_arg)
{
    ...
    return cfn_hal_base_callback_register(
        &driver->base, CFN_SAL_NWK_TYPE_CONNECTION, (cfn_hal_callback_t) callback, user_arg);
}
                                                                           ...
                                                                           cfn_hal_power_state_t     state)
{
    ...
    return cfn_hal_power_state_set(&driver->base, CFN_SAL_NWK_TYPE_CONNECTION, state);
}
                                                                        ...
                                                                        uint32_t                  event_mask)
{
    ...
    return cfn_hal_base_event_enable(&driver->base, CFN_SAL_NWK_TYPE_CONNECTION, event_mask);
}
                                                                         ...
                                                                         uint32_t                  event_mask)
{
    ...
    return cfn_hal_base_event_disable(&driver->base, CFN_SAL_NWK_TYPE_CONNECTION, event_mask);
}
                                                                     ...
                                                                     uint32_t                 *event_mask)
{
    ...
    return cfn_hal_base_event_get(&driver->base, CFN_SAL_NWK_TYPE_CONNECTION, event_mask);
}
                                                                        ...
                                                                        uint32_t                  error_mask)
{
    ...
    return cfn_hal_base_error_enable(&driver->base, CFN_SAL_NWK_TYPE_CONNECTION, error_mask);
}
                                                                         ...
                                                                         uint32_t                  error_mask)
{
    ...
    return cfn_hal_base_error_disable(&driver->base, CFN_SAL_NWK_TYPE_CONNECTION, error_mask);
}
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_sal_nwk_connection_connect(cfn_sal_nwk_connection_t *driver)
{
    ...
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_NWK_TYPE_CONNECTION, connect, driver, error);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC(CFN_SAL_NWK_TYPE_CONNECTION, disconnect, driver, error);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_NWK_TYPE_CONNECTION, get_status, driver, error, status_out);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_NWK_TYPE_CONNECTION, get_info, driver, error, info_out);
    return error;
}
                                                                         ...
                                                                         size_t                    max_count)
{
    ...
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(
        CFN_SAL_NWK_TYPE_CONNECTION, scan_networks, driver, error, results_array, max_count);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_NWK_TYPE_CONNECTION, get_mac_address, driver, error, mac_buf);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_NWK_TYPE_CONNECTION, get_ip_address, driver, error, ip_buf);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_NWK_TYPE_CONNECTION, get_gateway, driver, error, ip_buf);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_NWK_TYPE_CONNECTION, get_dns, driver, error, ip_buf);
    return error;
}
...
{
    cfn_hal_error_code_t error = CFN_HAL_ERROR_OK;
    CFN_HAL_CHECK_AND_CALL_FUNC_VARG(CFN_SAL_NWK_TYPE_CONNECTION, set_static_ip, driver, error, ip, mask, gateway);
    return error;
}
...
#endif /* CAFFEINE_SAL_NWK_CONNECTION_H */
